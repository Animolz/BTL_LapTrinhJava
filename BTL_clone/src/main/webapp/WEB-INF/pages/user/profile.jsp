...
<script>
        ...
        fetch("/BTL_clone/api/load-comments",{
            ...
            for (var i = 0; i < data.length; i++) {
                area.innerHTML = area.innerHTML + `
                        <div class="media border p-2 mt-1">
                                        <img src="`+ data[i].userId.avatar +`" alt="John Doe" class="mr-3 mt-3 rounded-circle" style="width:60px;">
                                        <div class="media-body">
                                            <h6>`+ data[i].userId.username +`<small class="text-muted"><i class="fa-regular fa-clock ml-2 text-muted"></i> `+ moment(data[i].createdDate).fromNow() +`</small></h6>
                                            <p>`+ data[i].comment +`</p>
                                        </div>
                                    </div>`;
            }
    ...
    function addComment(postId, userId){
            ...
            area.innerHTML = area.innerHTML + `
                    <div class="media border p-2 mt-1">
                                    <img src="`+ data[0].userId.avatar +`" alt="John Doe" class="mr-3 mt-3 rounded-circle" style="width:60px;">
                                    <div class="media-body">
                                        <h6>`+ data.userId[[0].username +`<small class="text-muted"><i class="fa-regular fa-clock ml-2 text-muted"></i> `+ moment(data[0].createdDate).fromNow() +`</small></h6>
                                        <p>`+ data[0].comment +`</p>
                                    </div>
                                </div>`;
        });
